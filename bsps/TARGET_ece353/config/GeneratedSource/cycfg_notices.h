...
#if !defined(CY8C6244AZI_S4D93)
#error "Unexpected MPN; expected DEVICE:=CY8C6244AZI-S4D93. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CY8C6244AZI_S4D93) */
